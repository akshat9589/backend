...
public class Orders {
	...
	Orders(){};
	Orders(Integer orderid,String customer_name ,String pickup_location,String images,Long final_price,String order_status, String pickup_day, String return_date){
	...
	public void setBike_details(Bike_details bike_details) {
		this.bike_details = bike_details;
	}
